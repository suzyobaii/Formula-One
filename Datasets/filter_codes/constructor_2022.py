...
df_2022 = df_merged[df_merged['year'] == 2022].copy()
...
df_2022_final = (
    df_2022.sort_values(by='raceId')
           .groupby('constructorId', as_index=False)
           .tail(1)
)

# 6. Select the columns you need
df_filtered = df_2022_final[['name', 'points', 'position', 'wins']].copy()
...
df_filtered.to_csv("2022_constructor_standings.csv", index=False)

print("Filtered 2022 constructor data has been saved to '2022_constructor_standings.csv'.")
